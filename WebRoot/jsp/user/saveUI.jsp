        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>登录名</td>
                        <td><s:textfield name="loginName" cssClass="InputStyle requried {minlength:2, maxlength:15, messages:{required:'请填写用户名！！！'}  } "/> *
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
                        <td><s:textfield name="name" cssClass="InputStyle requried "/> *</td>
                    </tr>
					<tr><td>性别</td>
                        <td>
                        	<%--
					...
					<tr><td>联系电话</td>
                        <td><s:textfield name="phoneNumber" cssClass="InputStyle requried"/></td>
                    </tr>
                    <tr><td>E-mail</td>
                        <td><s:textfield name="email" cssClass="InputStyle requried email"/></td>
                    </tr>
                    <tr><td>备注</td>
